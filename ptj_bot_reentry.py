...
재진입 버전 (Aggressive) - 청산 후 200 MA 위면 즉시 재진입

핵심 변경사항:
- 손절/트레일링 스탑 청산 후 가격이 여전히 200 MA 위면 즉시 재진입
- 200 MA 하향 돌파 청산은 재진입 없음 (추세 전환)
"""
